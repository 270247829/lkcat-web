...
<template>
    <i-article>
        <article>
            ...
            <Alert show-icon style="margin-top: 16px" type="warning">注意：没有使用 <router-link to="/docs/guide/lkcat-loader">lkcat-loader</router-link> 时，必须使用 <code>i-circle</code> 标签。</Alert>
