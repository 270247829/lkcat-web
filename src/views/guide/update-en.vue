            ...
            <Timeline pending>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        ...
                        <li>Fixed Menu with inline Submenu bug that throw errors after Vue.js 2.5.14. <a href="https://github.com/lkcat/lkcat/commit/b71a171d36e1327ee8fe1cc4f35fe97887f0786c" target="_blank">b71a171</a></li>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li><strong>Publish management system template <a href="https://github.com/lkcat/lkcat-admin" target="_blank">lkcat-admin</a>.</strong></li>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li>Publish <router-link to="/docs/guide/lkcat-loader-en">lkcat-loader</router-link> .</li>
                ...
                <Timeline-item color="green">
                    ...
                    <ul>
                        ...
                        <li>Fixed Table bug, set the height and add some data, the height is incorrect when data is empty. <a href="https://github.com/lkcat/lkcat/commit/119eeafedea02d984650b82920abdcdf4e809f79" target="_blank">commit</a></li>
                        <li>
