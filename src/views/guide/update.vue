            ...
            <Timeline pending>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        ...
                        <li>修复 Menu 多层嵌套在 Vue.js 2.5.14 版本之后报错的 bug。<a href="https://github.com/lkcat/lkcat/commit/b71a171d36e1327ee8fe1cc4f35fe97887f0786c" target="_blank">b71a171</a></li>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li><strong>发布后台管理系统模板 <a href="https://github.com/lkcat/lkcat-admin" target="_blank">lkcat-admin</a>。</strong></li>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li>发布 <router-link to="/docs/guide/lkcat-loader">lkcat-loader</router-link>。</li>
                ...
                <Timeline-item color="green">
                    ...
                    <ul>
                        ...
                        <li>修复 Table 在数据为空，设置表格高度时，添加数据后，表格高度计算不正确的bug。<a href="https://github.com/lkcat/lkcat/commit/119eeafedea02d984650b82920abdcdf4e809f79" target="_blank">commit</a></li>
                        <li>
                ...
                <Timeline-item>
                    ...
                    <ul>
                        <li>修复部分组件在非 template 内书写时不被识别的问题。部分组件新增别名，并兼任1.0版别名。
                            详见 <a href="https://github.com/lkcat/lkcat/blob/2.0/src/index.js#L49" target="_blank">https://github.com/lkcat/lkcat/blob/2.0/src/index.js#L49</a></li>
                    </ul>
                </Timeline-item>
                <Timeline-item color="green">
                    <Icon type="trophy" size="18" slot="dot"></Icon>
...
<script>
    ...
    export default {
        ...
        methods: {
            handleBefore () {
                window.open('http://v1.lkcatui.com/docs/guide/update');
            }
        }
    }
</script>