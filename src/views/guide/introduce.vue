<template>
    <i-article>
        <article>
            <h1>关于 LKCat</h1>
            <p>LKCat 是一套基于 Vue.js 的开源 UI 组件库，主要服务于 PC 界面的中后台产品。</p>
            ...
            <blockquote>
                如果你的公司和产品使用了LKCat，欢迎到 <a href="https://github.com/lkcat/lkcat/issues/2143" target="_blank">这里</a> 留言。
            </blockquote>
            ...
            <ul>
                <li>支持 Vue.js 2.x</li>
                <li>支持 Vue.js 1.x <a href="http://v1.lkcatui.com">查看 1.0 文档</a></li>
                <li>支持服务端渲染</li>
                <li>支持 Nuxt.js</li>
