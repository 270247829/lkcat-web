<template>
    <i-article>
        <article>
            <h1>Introduction</h1>
            <p>LKCat is a set of UI components and widgets built on Vue.js.</p>
            ...
            <Anchor title="Who's using LKCat" h2></Anchor>
            <ul>
                <li><a href="http://www.LANKEGP.com/" target="_blank">LANKEGP</a></li>
            ...
            <blockquote>
                If your company or products use LKCat, welcome to click <a href="https://github.com/lkcat/lkcat/issues/2143" target="_blank">here</a> to leave a message.
            </blockquote>
            ...
            <p>
                <a href="https://www.npmjs.com/package/lkcat" target="_blank">
                    <img src="https://img.shields.io/npm/v/lkcat.svg?style=flat-square">
                </a>
            </p>
            <Anchor title="Compatibility" h2></Anchor>
            <ul>
                <li>Support Vue.js 2.x</li>
                <li>Support Vue.js 1.x <a href="http://v1.lkcatui.com">Visit 1.0 doc</a></li>
                <li>Support SSR</li>
                <li>Support Nuxt.js</li>
                <li><a href="http://electron.atom.io/" target="_blank">Electron</a></li>
                <li>LKCat does not support IE8 or below since <a href="https://vuejs.org/v2/guide/reactivity.html" target="_blank">Vue.js</a> is using Object.defineProperty which do not be supported by these browsers to track changes.</li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <a href="https://git.oschina.net/icarusion/lkcat" target="_blank">码云</a>
                </li>
            </ul>
            <Anchor title="License" h2></Anchor>
            <p>LKCat is released under <a href="https://github.com/lkcat/lkcat/blob/2.0/LICENSE" target="_blank">MIT license</a></p>
        </article>
    </i-article>
</template>
<script>
