<template>
    <lk-article>
        <article>
            ...
            <p>Before using LKCat, we encourage you to read guide of Vue.js first.</p>
            <ul>
                <li>
            ...
            <Anchor title="LKCat CLI (Recommend)" h2></Anchor>
            <p>LKCat provide an <router-link to="/cli">CLI</router-link> for quickly construct a project with LKCat.</p>
            <Anchor title="Starter Kit" h2></Anchor>
            <p>We provide a starter kit <a href="https://github.com/lkcat/lkcat-project" target="_blank">lkcat-project</a> for you.</p>
            ...
            <p>The following components, you must add a prefix <code>i-</code>, unless you use <router-link to="/docs/guide/lkcat-loader-en">lkcat-loader</router-link>:</p>
            <ul>
