<template>
    <i-article>
        <article>
            ...
            <Anchor title="使用脚手架 LKCat Cli（推荐）" h2></Anchor>
            <p>使用 <router-link to="/cli">LKCat Cli</router-link> 可以通过可视化的方式快速构建 LKCat 工程，并且可以根据业务进行丰富的配置。</p>
            <Alert show-icon>
            ...
            <p>
                推荐工程：<a href="https://github.com/lkcat/lkcat-project" target="_blank">lkcat-project</a>
            </p>
            ...
            <Anchor title="引入 LKCat" h2></Anchor>
            ...
            <ul>
                <li>按需引用仍然需要导入样式，即在 <strong>main.js</strong> 或根组件执行 <code>import 'lkcat/dist/styles/lkcat.css';</code></li>
            ...
            <p>以下组件，在所有模式下，必须加前缀 <code>i-</code>，除非使用 <router-link to="/docs/guide/lkcat-loader">lkcat-loader</router-link>：</p>
            <ul>
